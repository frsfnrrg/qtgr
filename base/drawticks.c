...
/* draw tick labels */
	...
	if (t.tl_op == PLACE_BOTTOM || t.tl_op == PLACE_BOTH) {
	    (*devwritestr) ((*devconvx) (x), 
			    (*devconvy) (bot - delb) - ifudge * (1 + i % (t.tl_staggered + 1)), 
			    tang, s, bjust, 1);
	}
	if (t.tl_op == PLACE_TOP || t.tl_op == PLACE_BOTH) {
	    (*devwritestr) ((*devconvx) (x), 
			    (*devconvy) (top + delt) + ifudge * (1 + i % (t.tl_staggered + 1)), 
			    tang, s, tjust, 0);
	}
    }
	...
	if (t.tl_op == PLACE_BOTTOM || t.tl_op == PLACE_BOTH) {
		...
		view2world(vx, vyb, &ofx, &ofb);
		(*devwritestr) ((*devconvx) (ofx), (*devconvy) (ofb), lang1,
				t.label.s, ljust1, 0);
	    } else {
		(*devwritestr) ((int) (tmp), (*devconvy) (bot - delb) - 3 *
		    ifudge, lang1, t.label.s, ljust1, 0);
	    }
	}
	if (t.tl_op == PLACE_TOP || t.tl_op == PLACE_BOTH) {
	    if (t.label_place == TYPE_SPEC) {
		...
		vx = (v.xv1 + v.xv2)/2 + t.label.x;
		view2world(vx, vyb, &ofx, &ofb);
		(*devwritestr) ((*devconvx) (ofx), (*devconvy) (ofb), lang2,
				t.label.s, ljust2, 0);
	    } else {
		(*devwritestr) ((int) (tmp), (*devconvy) (top + delt) + 3 *
		    ifudge, lang2, t.label.s, ljust2, 0);
	    }
	}
    }
}
...
*/
	...
	if (t.tl_op == PLACE_LEFT || t.tl_op == PLACE_BOTH) {
		...
		view2world(vxl, vy, &ofl, &ofy);
		(*devwritestr) ((*devconvx) (ofl), (*devconvy) (ofy), lang1,
				t.label.s, ljust1, 0);
	    } else {
		(*devwritestr) ((*devconvx) (bot - dell) - (int) (1.4 * ylabpos),
				(int) (tmp), lang1, t.label.s, ljust1, 0);
	    }
	}
	if (t.tl_op == PLACE_RIGHT || t.tl_op == PLACE_BOTH) {
	    if (t.label_place == TYPE_SPEC) {
		...
		vy = (v.yv1 + v.yv2)/2 + t.label.y;
		view2world(vxl, vy, &ofl, &ofy);
		(*devwritestr) ((*devconvx) (ofl), (*devconvy) (ofy), lang2,
				t.label.s, ljust2, 0);
	    } else {
	        (*devwritestr) ((*devconvx) (top + delr) + (int) (1.4 * ylabpos),
			    (int) (tmp), lang2, t.label.s, ljust2, 0);
	    }
	}
    }
}
...
void drawxtickmarks(int gno, int caxis)
{
	...
	if (((t.t_op == PLACE_BOTTOM && !yinvflag) || ((t.t_op == PLACE_TOP) && yinvflag))
	    || t.t_op == PLACE_BOTH) {
	...
	start = s;
	if (((t.t_op == PLACE_TOP && !yinvflag) || ((t.t_op == PLACE_BOTTOM) && yinvflag))
	    || t.t_op == PLACE_BOTH) {
	    for (j = 0; j < nticks && start <= stop; j++) {
		logloop = 5;
		kstart = 0;
...
void drawytickmarks(int gno, int caxis)
{
	...
	if (((t.t_op == PLACE_LEFT && !xinvflag) || ((t.t_op == PLACE_RIGHT) && xinvflag))
	    || t.t_op == PLACE_BOTH) {
	    for (j = 0; j < nticks && start <= stop; j++) {
		logloop = 5;
		kstart = 0;
	...
	start = s;
	if (((t.t_op == PLACE_RIGHT && !xinvflag) || ((t.t_op == PLACE_LEFT) && xinvflag))
	    || t.t_op == PLACE_BOTH) {
	    for (j = 0; j < nticks && start <= stop; j++) {
		logloop = 5;
		kstart = 0;
