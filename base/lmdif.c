/*  -- translated by f2c (version 19960717). */

#include "config.h"
#include <math.h>
#define MAXNUM 1.79769313486231570815E308
#define MACHEP 1.1102230246251565404236E-16
#define UFLOWTHRESH 5.5626846462680034577256E-309
...
doublereal dpmpar_(integer *i)
{
    switch (*i) {
    	case 1:
    	    return (doublereal) MACHEP;
    	    break;
    	case 2:
    	    return (doublereal) UFLOWTHRESH;
    	    break;
    	case 3:
    	    return (doublereal) MAXNUM;
    	    break;
    	default:
    	    return (doublereal) 0;
    }
