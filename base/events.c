/* $Id: events.c,v 1.85 1993/03/09 14:20:09 pturner Exp pturner $
 *
...
extern Panel_item timestamp_x_item, timestamp_y_item;	/* from miscwin.c */
...
extern double find_point();
extern double find_item();
...
//     printf("drawgraph: %i %i %i %i\n",inwin,auto_redraw,force_redraw,tdevice);
    if (inwin && (auto_redraw || force_redraw)) {
	if (cursortype) {
	    cursor_oldx = cursor_oldy = -1;
	}
	//csto set_wait_cursor(NULL);
	//csto set_right_footer("Redraw...");
	initgraphics(tdevice);
// 	printf("drawgraph: maxgraph %i \n",maxgraph);
	for (i = 0; i < maxgraph; i++) {
// 	    printf("drawgraph: isactive %i %i \n",isactive_graph(i),g[i].hidden);
	    if (isactive_graph(i) && !g[i].hidden) {
		if (g[i].type == POLAR) {
		} else {
// 		    printf("drawgraph: check %i %i %i\n",checkon_ticks(i), checkon_world(i) , checkon_viewport(i));
	...
	//csto draw_focus(cg);
	force_redraw = FALSE;
	//csto set_right_footer(NULL);
	//csto unset_wait_cursor(NULL);
    }
}
...
void setpointer(x, y)
{
     //csto XWarpPointer(disp, None, xwin, 0, None, win_w, win_h, x, y);
}
...
void select_line(x1, y1, x2, y2)
    int x1, y1, x2, y2;
{
    //csto XDrawLine(disp, xwin, gcxor, x1, y1, x2, y2);
}
...
void draw_rectangle(x1, y1, x2, y2)
    int x1, y1, x2, y2;
{
    //csto XDrawRectangle(disp, xwin, gc, x1, y1, x2, y2);
}
...
// 	dy = -dy;
//     }
//     //csto XDrawRectangle(disp, xwin, gcxor, x1, y1, dx, dy);
// }
...
// 	//csto XFillRectangle(disp, xwin, gcxor, ix1 - 5, iy1 - 5, 10, 10);
// 	//csto XFillRectangle(disp, xwin, gcxor, ix1 - 5, iy2 - 5, 10, 10);
// 	//csto XFillRectangle(disp, xwin, gcxor, ix2 - 5, iy2 - 5, 10, 10);
// 	//csto XFillRectangle(disp, xwin, gcxor, ix2 - 5, iy1 - 5, 10, 10);
// /* TODO
// 	//csto XFillRectangle(disp, xwin, gcxor, (ix1 + ix2) / 2 - 5, iy1 - 5, 10, 10);
// 	//csto XFillRectangle(disp, xwin, gcxor, (ix1 + ix2) / 2 - 5, iy2 - 5, 10, 10);
// */
//     }
// }
...
//     case DEL_OBJECT:
// 	//csto set_cursor(3);
// 	//csto set_left_footer("Delete object");
// 	break;
//     case MOVE_OBJECT_1ST:
// 	//csto set_cursor(4);
// 	//csto set_left_footer("Pick object to move");
// 	break;
//     case MOVE_OBJECT_2ND:
// 	//csto set_left_footer("Place object");
// 	break;
//     case COPY_OBJECT1ST:
// 	//csto set_cursor(4);
// 	//csto set_left_footer("Pick object to copy");
// 	break;
//     case COPY_OBJECT2ND:
// 	//csto set_left_footer("Place object");
// 	break;
//     case MAKE_BOX_1ST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("First corner of box");
// 	break;
//     case MAKE_BOX_2ND:
// 	//csto set_left_footer("Second corner of box");
// 	break;
//     case STR_LOC1ST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Pick start of text line");
// 	break;
//     case STR_LOC2ND:
// 	//csto set_left_footer("Pick end of text line");
// 	break;
//     case MAKE_LINE_1ST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Pick beginning of line");
// 	break;
//     case MAKE_LINE_2ND:
// 	//csto set_left_footer("Pick end of line");
// 	break;
//     case STR_EDIT:
// 	//csto set_cursor(2);
// 	//csto set_left_footer("Edit string");
// 	break;
//     case STR_LOC:
// 	//csto set_cursor(2);
// 	//csto set_left_footer("Pick beginning of text");
// 	break;
//     case FIND_POINT:
// 	//csto set_cursor(1);
// 	//csto set_left_footer("Find points");
// 	break;
//     case TRACKER:
// 	//csto set_cursor(1);
// 	//csto set_left_footer("Tracker");
// 	break;
//     case DEF_REGION:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Define region");
// 	break;
//     case DEF_REGION1ST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Pick first point for region");
// 	break;
//     case DEF_REGION2ND:
// 	//csto set_left_footer("Pick second point for region");
// 	break;
//     case COMP_AREA:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Compute area");
// 	break;
//     case COMP_PERIMETER:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Compute perimeter");
// 	break;
//     case SEL_POINT:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Pick reference point");
// 	break;
//     case DEL_POINT:
// 	//csto set_cursor(3);
// 	//csto set_left_footer("Delete point");
// 	break;
//     case MOVE_POINT1ST:
// 	//csto set_cursor(4);
// 	//csto set_left_footer("Pick point to move");
// 	break;
//     case MOVE_POINT2ND:
// 	//csto set_left_footer("Pick final location");
// 	break;
//     case ADD_POINT:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Add point");
// 	break;
//     case PAINT_POINTS:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Paint points - hold left mouse button down and move");
// 	break;
//     case AUTO_NEAREST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Autoscale on nearest set - click near a point of the set to autoscale");
// 	break;
//     case KILL_NEAREST:
// 	//csto set_cursor(3);
// 	//csto set_left_footer("Kill nearest set - click near a point of the set to kill");
// 	break;
//     case COPY_NEAREST1ST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Copy nearest set - click near a point of the set to copy");
// 	break;
//     case COPY_NEAREST2ND:
// 	//csto set_cursor(0);
// 	sprintf(tmpbuf, "Selected S%1d in graph %d, click in the graph to place the copy", setno1, graphno1);
// 	//csto set_left_footer(tmpbuf);
// 	break;
//     case MOVE_NEAREST1ST:
// 	//csto set_cursor(4);
// 	//csto set_left_footer("Move nearest set - click near a point of the set to move");
// 	break;
...
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Join 2 sets - click near a point of the first set");
// 	break;
//     case JOIN_NEAREST2ND:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Join 2 sets - click near a point of the second set");
// 	break;
//     case DELETE_NEAREST1ST:
// 	//csto set_cursor(3);
// 	//csto set_left_footer("Delete points in a set - click near a point of the start of the range to  delete");
// 	break;
//     case DELETE_NEAREST2ND:
// 	//csto set_cursor(3);
// 	//csto set_left_footer("Delete points in a set - click near the end of the range to delete");
// 	break;
//     case REVERSE_NEAREST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Reverse order of nearest set - click near a point of the set to reverse");
// 	break;
//     case DEACTIVATE_NEAREST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Deactivate nearest set - click near a point of the set to deactivate");
// 	break;
//     case LEG_LOC:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Place legend");
// 	break;
//     case ZOOM_1ST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Pick first corner for zoom");
// 	break;
//     case ZOOM_2ND:
// 	//csto set_left_footer("Pick second corner for zoom");
// 	break;
//     case VIEW_1ST:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Pick first corner of viewport");
// 	break;
//     case VIEW_2ND:
// 	//csto set_left_footer("Pick second corner of viewport");
// 	break;
//     case PLACE_TIMESTAMP:
// 	//csto set_cursor(0);
// 	//csto set_left_footer("Click at the location for the timestamp");
// 	break;
//     case 0:
// 	//csto set_cursor(-1);
// 	//csto set_left_footer("Locator");
// 	if (rectflag) {
// 	    select_region(sx, sy, old_x, old_y);
// 	    rectflag = 0;
// 	}
...
// 	char	   	*string;
// 
// 	xv_set(sel, SEL_TYPE_NAME, "FILE_NAME", NULL);
//     	string = (char *) xv_get(sel, SEL_DATA, &length, &format);
//     	if (length != SEL_ERROR) {
// 		strncpy((char *)&filename, string, length);
// 		filename[length]='\0';
// 	/* load File */
// 		wipeout(1);
// 		getdata(cg, &filename, DISK, XY);
//         /* force redraw */
// 		doforce_redraw();
// 	}
// }
...
// void 
// drop_notify_proc(item,value,event)
// 	Panel_item	item;
// 	unsigned int	value;
// 	Event           *event;
// 
...
// 		drop_load(event);
// 	    xv_set(main_frame, FRAME_CLOSED, FALSE, 0);
//     	    return(NOTIFY_DONE);
// 	    break;
// 	}
// 	case ACTION_DRAG_MOVE: {
...
// 
//     xv_set(sel, SEL_TYPE, xv_get(server, SERVER_ATOM, "FILE_NAME"), 0);
//     if ((string = (char *) xv_get(sel, SEL_DATA, &length, &format)) != NULL) {
...
// 	string = (char *) xv_get(sel, SEL_DATA, &length, &format);
// 
// 	sprintf(tmpname, "rm -f /tmp/xvgr%d.drag", getpid());
// 	fn = fopen(&(tmpname[6]), "w");
// 	fprintf(fn, string);
// 	fclose(fn);
// 	getdata(cg, &(tmpname[6]), DISK, XY);
// 	system(tmpname);
// 
//     }
//     if (debuglevel == 8) {
...
//     case KeyPress:
// 	buf[0] = 0;
// 	//csto XLookupString((XKeyEvent *) event, buf, 1, &keys, &compose);
// 	switch (c = buf[0]) {
// 	case 1:		/* ^A */
// 	    if (activeset(cg)) {
// 		defaultgraph(cg);
...
// 			//csto XDrawLine(disp, xwin, gc, iax[i], iay[i], iax[(i + 1) % narea_pts], iay[(i + 1) % narea_pts]);
// 		    }
// 		}
// 	    }
...
// 			//csto XDrawLine(disp, xwin, gc, iax[i], iay[i], iax[(i + 1) % region_pts], iay[(i + 1) % region_pts]);
// 		    }
...
// 			if (symok(wx, wy)) {
// /* 			    printf("test: %lf \n", */
// 			    find_point(cg, wx, wy, &wx, &wy, &setno, &loc)
// /*			    ) */
// 			    ;
// 			    if (setno != -1) {
// 				cset = setno;
...
// 		{
// 		    device2world(x, y, &wx, &wy);
// 		    find_point(cg, wx, wy, &wx, &wy, &setno1, &loc1);
...
// 		    device2world(x, y, &wx, &wy);
// 		    graphno2 = iscontained(cg, wx, wy);
// 		    find_point(graphno2, wx, wy, &wx, &wy, &setno, &loc);
...
// 			set_action(0);
// 		    } else if (graphno2 != -1) {
// 			find_point(graphno2, wx, wy, &wx, &wy, &setno2, &loc2);
// 			if (graphno1 != graphno2) {
...
// 			//csto //csto xv_setstr(locate_point_item, buf);
...
// 		    if (track_set == -1) {
// 			device2world(x, y, &wx, &wy);
// 			find_point(cg, wx, wy, &wx, &wy, &track_set, &track_point);
// 			track_point--;
// 			if (track_point < 0) {
// 			    track_point = 0;
// 			}
...
// 			//csto xv_setstr(locate_point_item, buf);
// 			set_action(0);
// 		    } else {
// 			sprintf(buf, "Set %d, loc %d, (%lf, %lf)", setno, loc, wx, wy);
// 			//csto xv_setstr(locate_point_item, buf);
...
// 	    case MOVE_POINT1ST:
// 		device2world(x, y, &wx, &wy);
// 		find_point(cg, wx, wy, &wx, &wy, &setnumber, &setindex);
...
// 			//csto xv_setstr(locate_point_item, buf);
// 			//csto //csto XDrawLine(disp, xwin, gc, x - 5, y - 5, x + 5, y + 5);
// 			//csto //csto XDrawLine(disp, xwin, gc, x - 5, y + 5, x + 5, y - 5);
...
// 		    wy = yconv(wy);
// 		}
// //csto 		if (timestamp_x_item) {
// // 		    sprintf(buf, "%lg", wx);
// // 		    //csto xv_setstr(timestamp_x_item, buf);
// // 		    sprintf(buf, "%lg", wy);
// // 		    //csto xv_setstr(timestamp_y_item, buf);
// // 		}
// 		timestamp.x = wx;
// 		timestamp.y = wy;
// 		set_action(0);
...
// 		    wy = yconv(wy);
// 		}
// // csto		if (legend_x_panel) {
// // 		    sprintf(buf, "%.6g", wx);
// // 		    //csto xv_setstr(legend_x_panel, buf);
// // 		    sprintf(buf, "%.6g", wy);
// // 		    //csto xv_setstr(legend_y_panel, buf);
// // 		} else {
// 		    g[cg].l.legx = wx;
// 		    g[cg].l.legy = wy;
// // 		}
...
//     //csto //csto XDrawLine(disp, xwin, gcxor, 0, cursor_oldy, win_w, cursor_oldy);
//     //csto XDrawLine(disp, xwin, gcxor, cursor_oldx, 0, cursor_oldx, win_h);
// 
//     /* Draw the new crosshair */
//     cursor_oldx = e->x;
//     cursor_oldy = e->y;
//     //csto XDrawLine(disp, xwin, gcxor, 0, cursor_oldy, win_w, cursor_oldy);
//     //csto XDrawLine(disp, xwin, gcxor, cursor_oldx, 0, cursor_oldx, win_h);
// }
// 
// /*
...
// }
// 
// void switch_current_graph(gfrom, gto)
//     int gfrom, gto;
// {
//     draw_focus(gfrom);
//     cg = gto;
