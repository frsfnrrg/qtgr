/* $Id: objutils.c,v 1.7 1992/11/29 14:46:57 pturner Exp pturner $
 *
 ...
 */
double find_item(gno, x, y, type, numb)
    int gno;
    double x, y;
    int *type, *numb;
{
...
void do_copy_object_proc()
{
    set_action(0);
    set_action(COPY_OBJECT1ST);
}

void do_cut_object_proc()
{
    set_action(0);
